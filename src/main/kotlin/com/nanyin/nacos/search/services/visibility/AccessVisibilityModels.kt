 ...
 * across every class; capability-scoped authorization is layered later (#124–#125).
 */
 ...
 *
 * [Visible] means the identity is not under an access block for configuration
 * data. [Blocked] is distinct from a cache miss: the payload may still exist
 * in the store and becomes readable again after a matching success.
 */
